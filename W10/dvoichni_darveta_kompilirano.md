...
- **КДЛ**: 2;5;9;4;7;6;11;5;2 (обратен preorder)
- **ДКЛ**: 9;4;5;2;11;6;5;7;2 (обратен inorder)
- **ДЛК**: 4;9;5;11;5;6;2;7;2 (обратен postorder)
- **КЛД**: 2;7;2;6;5;11;5;9;4 (preorder)
- **ЛКД**: 2;7;5;6;11;2;5;4;9 (inorder)
- **ЛДК**: 2;5;11;6;7;4;9;5;2 (postorder)

**Практическа приложимост**
Обратните обхождания **се използват рядко** в практиката. Те намират приложение в специфични случаи:

- **Симетрични операции** - когато е необходимо да се обработи дървото в огледален ред
- **Специализирани алгоритми** - например при някои видове балансиране или трансформации на дървета
- **Теоретични изследвания** - за пълнота при анализа на всички възможни обхождания

В стандартните учебници и практическите приложения обикновено се разглеждат само първите три обхождания, тъй като те покриват почти всички необходимости при работа с двоични дървета за търсене, аритметични изрази и други структури от данни.
...
### Пълна програма с детайлни коментари
